...
public final class G {
	...
	// ------------------------------------------------------------------------
	/**
	 * uses the u unifier to unify each string in the vector v.
	 */
	public static String substitute(Vector<String> v, Unifier u) {
		if (v == null)
			return null;
	...
	public static OperatorHead substitute(OperatorHead opHead, Unifier unifier) {
		...
		while (it_head_var.hasNext()) {
			...
			oph.parList.put(unifier.get(var_name), var_name);
